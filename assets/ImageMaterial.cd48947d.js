import{d0 as y,d1 as $,d2 as O,cN as _,d3 as x,r as v,d4 as A,d5 as d,d6 as S,d7 as C,d8 as E,d9 as b,bt as o,da as T,db as w,dc as c,dd as F,br as D,de as N,df as f,e as n,dg as l,dh as g,di as M,dj as R,dk as I,dl as L,dm as U,dn as B,dp as W,dq as z,dr as G,ds as j,dt as H,du as q,dv as Q,dw as V,dx as k,dy as J,dz as K,dA as X,bu as u,dB as Y,dC as Z,dD as ee,dE as te}from"./index.f2e9cdcf.js";function ae(a){const e=new y,{vertex:t,fragment:s}=e;return $(t,a),e.include(O,a),e.attributes.add(_.POSITION,"vec3"),e.attributes.add(_.UV0,"vec2"),e.varyings.add("vpos","vec3"),a.hasMultipassTerrain&&e.varyings.add("depth","float"),t.uniforms.add(new x("textureCoordinateScaleFactor",r=>v(r.texture)&&v(r.texture.descriptor.textureCoordinateScaleFactor)?r.texture.descriptor.textureCoordinateScaleFactor:A)),t.code.add(d`
    void main(void) {
      vpos = position;
